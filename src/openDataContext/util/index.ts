...
/** 获取好友数据排行榜 */
export const getFriendList = (): Promise<readonly UserGameData[]> => {
...
/** 获取相邻好友的数据 */
export const getNearFriendList = async (openId: string): Promise<UserGameData[]> => {
...
export const uploadScore = async (score: number) => {
  // 设置分数
  const setScore = (newScore): Promise<void> => {
    return new Promise((resolve, reject) => {
